...
{
    private SerializedProperty joystickListener;
    ...
    protected virtual void OnEnable()
    {
        ...
        joystickListener = serializedObject.FindProperty("joystickListener");
    }
    ...
    {
        EditorGUILayout.PropertyField(joystickListener, new GUIContent("joystickListener"));
